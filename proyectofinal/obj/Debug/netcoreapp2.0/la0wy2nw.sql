...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180409003518_3Migration', N'2.0.1-rtm-125');

GO

EXEC sp_rename N'Productos.Precion', N'Precio', N'COLUMN';

GO

ALTER TABLE [Empresas] ADD [PhoneNumber] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180409013324_4Migration', N'2.0.1-rtm-125');
...
ALTER TABLE [RegisterViewModel] ADD [Role] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180411212230_5Migration', N'2.0.1-rtm-125');
