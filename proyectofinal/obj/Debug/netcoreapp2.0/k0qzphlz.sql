...
CREATE TABLE [Productos] (
    ...
    CONSTRAINT [FK_Productos_Empresas_EmpresaId1] FOREIGN KEY ([EmpresaId1]) REFERENCES [Empresas] ([Id]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_Productos_EmpresaId1] ON [Productos] ([EmpresaId1]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180403225946_MyMigracion', N'2.0.1-rtm-125');
