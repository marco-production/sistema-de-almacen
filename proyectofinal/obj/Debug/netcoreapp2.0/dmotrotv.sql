...
ALTER TABLE [Empresas] ADD [RegisterViewModelId1] int NULL;

GO

CREATE INDEX [IX_Empresas_RegisterViewModelId1] ON [Empresas] ([RegisterViewModelId1]);

GO

ALTER TABLE [Empresas] ADD CONSTRAINT [FK_Empresas_RegisterViewModel_RegisterViewModelId1] FOREIGN KEY ([RegisterViewModelId1]) REFERENCES [RegisterViewModel] ([Id]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180408235132_3Migration', N'2.0.1-rtm-125');
