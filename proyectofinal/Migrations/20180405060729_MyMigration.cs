        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletoNombre = table.Column<string>(nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Ciudad = table.Column<string>(maxLength: 250, nullable: false),
                    Email = table.Column<string>(maxLength: 255, nullable: false),
                    Estado = table.Column<string>(maxLength: 250, nullable: false),
                    Nombre = table.Column<string>(maxLength: 100, nullable: false),
                    Pais = table.Column<string>(maxLength: 250, nullable: false),
                    RegisterId = table.Column<string>(nullable: false),
                    RegisterViewModelId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empresas_RegisterViewModel_RegisterViewModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Precion = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Empresas_RegisterViewModelId",
                table: "Empresas",
