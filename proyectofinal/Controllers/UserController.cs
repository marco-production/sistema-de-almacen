...
namespace proyectofinal.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            return View(await _context.ApplicationUser.SingleOrDefaultAsync(m => m.Id == id));
        }
        ...
        {
            var applicationUser = await _context.ApplicationUser.SingleOrDefaultAsync(m => m.Id == id);
            var Eliminar_Productos = await _context.Productos.SingleOrDefaultAsync(m => m.RegisterId == applicationUser.Id);
            var Eliminar_Empresas = await _context.Empresas.SingleOrDefaultAsync(m => m.RegisterId == applicationUser.Id);
